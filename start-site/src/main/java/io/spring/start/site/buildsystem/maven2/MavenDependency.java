...
public class MavenDependency extends Dependency {
	...
	public static class Builder extends Dependency.Builder<Builder> {
		...
		protected Builder initialize(Dependency dependency) {
			...
			if (dependency instanceof io.spring.initializr.generator.buildsystem.maven.MavenDependency) {
				optional(((io.spring.initializr.generator.buildsystem.maven.MavenDependency) dependency).isOptional());
			}
			return self();
		}
